...
if __name__ == '__main__':
    ...
    model_dir = os.path.join('../checkpoint',config['data_loader']['name'], config['model_name'], 'eval', date_time)

    # model_dir = os.path.join('../checkpoint', config['model_name'], 'eval',date_time)
    # if config['data_loader']['name'] == 'UCIHandDataset':
    #     model_dir = os.path.join('../checkpoint_UCI', config['model_name'], 'eval',date_time)
    ...
    utils.load_checkpoint(os.path.join(config["model_dir"], 'best.tar'), model)
